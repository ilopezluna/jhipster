...
class ItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Item entity")
        ...
        .repeat(2) {
            ...
            .put("/api/items")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "createdAt":"2020-01-01T00:00:00.000Z", "updatedAt":"2020-01-01T00:00:00.000Z", "price":null, "status":"0", "latitude":"SAMPLE_TEXT", "longitude":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
